...
#
# windows_rebuild.tcl: Tcl script for re-creating project 'vivado_project'
#
# Generated by Vivado on Sat Sep 21 02:27:05 -0700 2024
...
#
# 1. This project restoration tcl script (windows_rebuild.tcl) that was generated.
#
...
#
#    "H:/Develop/fpga-gameboy/src/Gameboy_PL/hdl/Gameboy_PL_wrapper.v"
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/src/Gameboy_PL/hdl/Gameboy_PL_wrapper.v"]"\
...
set script_file "windows_rebuild.tcl"
...
set_property -name "board_part_repo_paths" -value "G:/Xilinx/Vivado/2024.1/data/boards/board_files" -objects $obj
...
set_property -name "top" -value "Gameboy_PL_wrapper" -objects $obj
...
# Proc to create BD Gameboy_PL
proc cr_bd_Gameboy_PL { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name Gameboy_PL
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-669,-740",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.7.1 2023-07-26 3bc4126617 VDI=43 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 2 -x 420 -y -350 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 2 -x 420 -y -330 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 200 -y -300 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 2 20 -190 380
preplace netloc processing_system7_0_DDR 1 1 1 NJ -350
preplace netloc processing_system7_0_FIXED_IO 1 1 1 NJ -330
levelinfo -pg 1 -20 200 420
pagesize -pg 1 -db -bbox -sgen -20 -410 540 200
"
}
...
# End of cr_bd_Gameboy_PL()

cr_bd_Gameboy_PL ""
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files Gameboy_PL.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files Gameboy_PL.bd ] 
